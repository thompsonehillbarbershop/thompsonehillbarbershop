...
export default function NoPreferenceCard({
  ...
  return (
    <div
      role="button"
      onClick={handleClick}
      className={cn("relative w-full sm:w-52 md:size-64 bg-card flex flex-col items-center justify-center gap-1 pt-4 pb-2 px-4 border-transparent border-4 rounded-lg shadow-md")}>
